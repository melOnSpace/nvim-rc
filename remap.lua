...
vim.keymap.set("n", "<C-;>", "q:", { noremap = true, desc = "Opens command mode in a buffer" })
...
vim.keymap.set({"n", "v"}, "<leader>Y", [["+Y]], { desc = "Yank up to whitespace to system clipboard" })
vim.keymap.set({"n", "v"}, "<leader>p", [["+p]], { desc = "Paste system clipboard" })
vim.keymap.set({"n", "v"}, "<leader>P", [["+P]], { desc = "Paste behind from system clipboard" })
vim.keymap.set({"n", "v"}, "<leader><C-p>", [["_diwp]], { desc = "Delete but keet current \" register" })
